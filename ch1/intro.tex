...
\paragraph{Topic 3: Causality Inference to Climate Related Protest}
...
%novel approaches to track them on social media. In particular, interactions in this space and how
%they evolve into social movements in still unclear. We aim to combine analysis of historical news/posts and extract relevant information chains. By combining such analysis with social media, we aim to extract pertinent social media activity.
...
% By analyzing large historical news reports and social media posts, we developed methods to detect information chain which can suggest how key events translate or influence social movements.
