...
\end{itemize}
We evaluate the model performance temporally and spatially. Temporally, we compare the estimated time series with the real time series using three different approaches: Euclidean distance, Cosine Similarity and Correlation[cite book introduction to data mining, Pang-Ning Tan]. We also compute the accuracy for the model, where the accuracy is defined as $$accuracy=\frac{number of esteimate protests}{real protest}$$. We table the performance for the five protests below, which shows that our model outperform other approaches.
Spatially, we compare the subgraph structures and table the results below, which shows our model can beat other base ground approaches.
\begin{table*}[!ht]
\tiny
\caption{GBM Model performance evaluation.}
\centering
\begin{tabular}{ |l|l|l|l|l|l|}
\hline
{Protest} & Model & Euclidean distance  & Cosine Similarity & Correlation & Accuracy\\ \cline{2-6} \hline \hline
\multirow{3}{*}{Prot1} & random assign & 0.53  & 0.78 & 0.82 & 0.67\\ \cline{2-6}
 & naive Bayes & 0.61  & 0.66 & 0.52 & 0.68\\ \cline{2-6}
 & GBM & 0.32  & 0.82  & 0.74 & 0.73\\ \hline
\multirow{3}{*}{Prot2} & random assign & 0.53  & 0.78 & 0.82 & 0.67\\ \cline{2-6}
 & naive Bayes & 0.61  & 0.66 & 0.52 & 0.68\\ \cline{2-6}
 & GBM & 0.32  & 0.82  & 0.74 & 0.73\\ \hline
\multirow{3}{*}{Prot3} & random assign & 0.53  & 0.78 & 0.82 & 0.67\\ \cline{2-6}
 & naive Bayes & 0.61  & 0.66 & 0.52 & 0.68\\ \cline{2-6}
 & GBM & 0.32  & 0.82  & 0.74 & 0.73\\ \hline
\multirow{3}{*}{Prot4} & random assign & 0.53  & 0.78 & 0.82 & 0.67\\ \cline{2-6}
 & naive Bayes & 0.61  & 0.66 & 0.52 & 0.68\\ \cline{2-6}
 & GBM & 0.32  & 0.82  & 0.74 & 0.73\\ \hline
\multirow{3}{*}{Prot5} & random assign & 0.53  & 0.78 & 0.82 & 0.67\\ \cline{2-6}
 & naive Bayes & 0.61  & 0.66 & 0.52 & 0.68\\ \cline{2-6}
 & GBM & 0.32  & 0.82  & 0.74 & 0.73\\ \hline
\multirow{3}{*}{Prot6} & random assign & 0.53  & 0.78 & 0.82 & 0.67\\ \cline{2-6}
 & naive Bayes & 0.61  & 0.66 & 0.52 & 0.68\\ \cline{2-6}
 & GBM & 0.32  & 0.82  & 0.74 & 0.73\\ \hline
\multirow{3}{*}{Prot7} & random assign & 0.53  & 0.78 & 0.82 & 0.67\\ \cline{2-6}
 & naive Bayes & 0.61  & 0.66 & 0.52 & 0.68\\ \cline{2-6}
 & GBM & 0.32  & 0.82  & 0.74 & 0.73\\ \hline
\end{tabular}
...
\hline
\end{tabular}
\label{table:performance_evaluation}
\end{table*}
